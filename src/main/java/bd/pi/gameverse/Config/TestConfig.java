...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario usuario1 = new Usuario("João", "athyla", LocalDate.of(2000, 5, 12), "aa@gmail.com", "123", "123",
        ...
        Administrador administrador1 = new Administrador("Edu", "joSa", "@gmail.com", "eu",
                new Status(1l, StatusEnum.ATIVO));
